...
public class DeadLock_Example {
    ...
    public void incrementCounters_DeadlockSituation(int count1, int count2){
    ...
    public void incrementCounters(int count1, int count2){
        ...
        Runnable runnable1 = new Runnable1_Deadlock(count1,count2,lock1,lock2);
        // Runnable2 also implements class Runnable1_deadlock, therefore, we will not have a deadlock.
        Runnable runnable2 = new Runnable1_Deadlock(count1,count2,lock1,lock2);
